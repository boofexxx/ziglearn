...
test "errdefer" {
    ...
    try expect(problems == 98); // is never reached
}
...
test "inferred error set" {
    // type coercion successfully takes places
...
test "switch statement" {
    ...
    switch (x) {
        ...
        10, 100 => {
            // special considertaion must be made
...
// test "unreachable" {
//     const x: i32 = 1;
//     const y: u32 = if (x == 2) 5 else unreachable; // reached unreachable
//     _ = y;
// }
...
//     var x: u16 = 0;
//     var y: *u8 = @intToPtr(*u8, x); // error: cast causes pointer to be null
//     _ = y;
// }
...
test "simple union" {
    ...
    _ = result;
    // result.float = 12.34; // access of inactive union field
}
...
// Zig provides overflow operators
// + 	+%
// - 	-%
// * 	*%
// += 	+%=
